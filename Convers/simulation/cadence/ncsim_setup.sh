...
# ACDS 18.1 625 win32 2022.02.22.21:02:36
...
# ----------------------------------------
# If Convers is one of several IP cores in your
...
TOP_LEVEL_NAME="Convers"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="K:/intelfpga_lite/18.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fpoint2_multi.vhd"                       -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fpoint2_multi_datapath.vhd"              -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fpoint2_multi_dspba_library_package.vhd" -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fpoint2_multi_dspba_library.vhd"         -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FPAddSub/FPAddSub.vhd"                   -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FPDiv/FPDiv.vhd"                         -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FPMult/FPMult.vhd"                       -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/IntToFloat/IntToFloat.vhd"               -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FloatToInt/FloatToInt.vhd"               -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FPSqrt/FPSqrt_safe_path.vhd"             -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FPSqrt/FPSqrt.vhd"                       -work nios_custom_instr_floating_point_2_multi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_multi_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/Convers.v"                                                                                                                                                                
fi
