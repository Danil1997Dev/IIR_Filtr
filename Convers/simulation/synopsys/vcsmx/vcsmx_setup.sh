...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/fpoint2_multi.vhd"                       -work nios_custom_instr_floating_point_2_multi_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/fpoint2_multi_datapath.vhd"              -work nios_custom_instr_floating_point_2_multi_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/fpoint2_multi_dspba_library_package.vhd" -work nios_custom_instr_floating_point_2_multi_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/fpoint2_multi_dspba_library.vhd"         -work nios_custom_instr_floating_point_2_multi_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/FPAddSub/FPAddSub.vhd"                   -work nios_custom_instr_floating_point_2_multi_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/FPDiv/FPDiv.vhd"                         -work nios_custom_instr_floating_point_2_multi_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/FPMult/FPMult.vhd"                       -work nios_custom_instr_floating_point_2_multi_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/IntToFloat/IntToFloat.vhd"               -work nios_custom_instr_floating_point_2_multi_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/FloatToInt/FloatToInt.vhd"               -work nios_custom_instr_floating_point_2_multi_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/FPSqrt/FPSqrt_safe_path.vhd"             -work nios_custom_instr_floating_point_2_multi_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/FPSqrt/FPSqrt.vhd"                       -work nios_custom_instr_floating_point_2_multi_0
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Convers.v"                                                                                          
fi
