...
# ACDS 18.1 625 win32 2022.02.20.16:21:09
...
# ----------------------------------------
# If FP_SUB is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP_SUB.vo"
fi
