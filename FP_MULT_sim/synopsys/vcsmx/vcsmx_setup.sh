...
# ACDS 18.1 625 win32 2022.02.20.16:22:58
...
# ----------------------------------------
# If FP_MULT is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP_MULT.vo"
fi
